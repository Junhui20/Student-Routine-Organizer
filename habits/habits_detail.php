...
<div class="container">
  ...
  <a href="index.php" class="btn btn-primary" style="height:40px; display:flex; align-items:center;">
    ...
    <div style="max-height:300px; overflow-y:auto;">
      <?php foreach ($logs as $log): ?>
        <div style="display:flex;justify-content:space-between; padding:.5rem 0; border-bottom:1px solid #eee;">
          ...
          <span><?= $log['status'] === 'done' ? '✔' : '✖' ?> <?= $log['duration'] ? '(' . htmlspecialchars($log['duration']) . ' min)' : '' ?></span>
        </div>
      <?php endforeach; ?>
    ...
    <div class="action-buttons">
      ...
      <form method="post" action="delete_habit.php" onsubmit="return confirm('Delete this habit? This removes logs too.')">
